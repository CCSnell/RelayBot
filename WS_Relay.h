...
extern uint32_t Channel_Pulse_Durations[8];  // Pulse durations for each channel (ms)
extern uint32_t Channel_Pulse_Counts[8];  // Pulse counts for each channel (number of cycles)
